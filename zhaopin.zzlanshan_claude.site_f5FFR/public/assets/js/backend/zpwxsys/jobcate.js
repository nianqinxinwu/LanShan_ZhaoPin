define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'zpwxsys/jobcate/index' + location.search,
                    add_url: 'zpwxsys/jobcate/add',
                    edit_url: 'zpwxsys/jobcate/edit',
                    del_url: 'zpwxsys/jobcate/del',
                    multi_url: 'zpwxsys/jobcate/multi',
                    table: 'zpwxsys_jobcate',
                }
            });
