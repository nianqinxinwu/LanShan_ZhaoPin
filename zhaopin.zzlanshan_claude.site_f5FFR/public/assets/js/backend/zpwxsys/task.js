define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'zpwxsys/task/index' + location.search,
                    add_url: 'zpwxsys/task/add',
                    edit_url: 'zpwxsys/task/edit',
                    del_url: 'zpwxsys/task/del',
                    multi_url: 'zpwxsys/task/multi',
                    table: 'zpwxsys_task',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'jobtitle', title: __('jobtitle'), operate:false},
