define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'zpwxsys/lookrole/index' + location.search,
                    add_url: 'zpwxsys/lookrole/add',
                    edit_url: 'zpwxsys/lookrole/edit',
                    del_url: 'zpwxsys/lookrole/del',
                    multi_url: 'zpwxsys/lookrole/multi',
                    table: 'zpwxsys_lookrole',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'looknum', title: __('looknum')},
