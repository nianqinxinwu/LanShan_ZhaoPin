define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'zpwxsys/city/index' + location.search,
                    add_url: 'zpwxsys/city/add',
                    edit_url: 'zpwxsys/city/edit',
                    del_url: 'zpwxsys/city/del',
                    multi_url: 'zpwxsys/city/multi',
                    table: 'zpwxsys_city',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'ison', title: __('ison'), formatter: Table.api.formatter.toggle},
