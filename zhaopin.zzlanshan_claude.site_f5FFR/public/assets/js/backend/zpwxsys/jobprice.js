define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'zpwxsys/jobprice/index' + location.search,
                    add_url: 'zpwxsys/jobprice/add',
                    edit_url: 'zpwxsys/jobprice/edit',
                    del_url: 'zpwxsys/jobprice/del',
                    multi_url: 'zpwxsys/jobprice/multi',
                    table: 'zpwxsys_jobprice',
                }
            });
