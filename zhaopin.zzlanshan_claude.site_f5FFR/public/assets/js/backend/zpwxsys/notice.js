define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'zpwxsys/notice/index' + location.search,
                    add_url: 'zpwxsys/notice/add',
                    edit_url: 'zpwxsys/notice/edit',
                    del_url: 'zpwxsys/notice/del',
                    multi_url: 'zpwxsys/notice/multi',
                    table: 'zpwxsys_notice',
                }
            });
