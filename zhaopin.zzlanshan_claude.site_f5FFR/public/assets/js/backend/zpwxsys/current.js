define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'zpwxsys/current/index' + location.search,
                    add_url: 'zpwxsys/current/add',
                    edit_url: 'zpwxsys/current/edit',
                    del_url: 'zpwxsys/current/del',
                    multi_url: 'zpwxsys/current/multi',
                    table: 'zpwxsys_current',
                }
            });
