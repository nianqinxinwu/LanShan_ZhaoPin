define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'zpwxsys/area/index' + location.search,
                    add_url: 'zpwxsys/area/add',
                    edit_url: 'zpwxsys/area/edit',
                    del_url: 'zpwxsys/area/del',
                    multi_url: 'zpwxsys/area/multi',
                    import_url: 'zpwxsys/area/import',
                    table: 'zpwxsys_area',
                }
            });
