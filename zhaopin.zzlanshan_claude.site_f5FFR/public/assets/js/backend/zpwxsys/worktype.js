define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'zpwxsys/worktype/index' + location.search,
                    add_url: 'zpwxsys/worktype/add',
                    edit_url: 'zpwxsys/worktype/edit',
                    del_url: 'zpwxsys/worktype/del',
                    multi_url: 'zpwxsys/worktype/multi',
                    table: 'zpwxsys_worktype',
                }
            });
