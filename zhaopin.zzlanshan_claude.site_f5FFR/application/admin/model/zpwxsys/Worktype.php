<?php
    ...
    class Worktype extends Model
    {
         ...
         * @author
         */
        public function getWorktypeByWhere($map, $Nowpage, $limits, $od)
        {
            return $this->where($map)->page($Nowpage, $limits)->order($od)->select();
            
        }
        
        public function getWorktypeCount($map)
        {
         ...
         * @author
         */
        public function insertWorktype($param)
        {
            Db::startTrans();// 启动事务
            try {
         ...
         * @author
         */
        public function updateWorktype($param)
        {
            Db::startTrans();// 启动事务
            try {
