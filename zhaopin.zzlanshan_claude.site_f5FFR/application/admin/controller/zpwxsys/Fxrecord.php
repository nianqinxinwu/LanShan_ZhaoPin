<?php
    ...
    use app\admin\model\zpwxsys\Fxrecord as FxrecordModel;
     ...
     * 分销佣金记录
     */
    class Fxrecord extends Backend
    {
        ...
        public function index()
        {
            ...
            if ($this->request->isAjax()) {
              ...
              //  $map['n.tid'] = array('gt',0);
                ...
                $fxrecord = new FxrecordModel();
                $count = $fxrecord->getFxrecordCount($map);
                $Nowpage = $offset / $limit + 1;
           
                $list = $fxrecord->getFxrecordByWhere($map, $Nowpage, $limit, $od);
                if($list)
                {
                    foreach ($list as $k=>$v) {
