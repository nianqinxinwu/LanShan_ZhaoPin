<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:97:"/www/wwwroot/zhaopin.zzlanshan.site/public/../application/admin/view/zpwxsys/companyrole/add.html";i:1768209977;s:78:"/www/wwwroot/zhaopin.zzlanshan.site/application/admin/view/layout/default.html";i:1746006160;s:75:"/www/wwwroot/zhaopin.zzlanshan.site/application/admin/view/common/meta.html";i:1746006160;s:77:"/www/wwwroot/zhaopin.zzlanshan.site/application/admin/view/common/script.html";i:1746006160;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-jobnum" data-rule="required" class="form-control" name="row[jobnum]" type="number">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-notenum" data-rule="required" class="form-control" name="row[notenum]" type="number">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-topnum" data-rule="required" class="form-control" name="row[topnum]" type="number">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-days" data-rule="required" class="form-control" name="row[days]" type="number">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="radio">
                <label for="row[isinit]-normal"><input  name="row[isinit]" type="radio" value="1" checked=""> 是</label>
                <label for="row[isinit]-hidden"><input  name="row[isinit]" type="radio" value="0"> 否</label>
            </div>
        </div>
    </div>
