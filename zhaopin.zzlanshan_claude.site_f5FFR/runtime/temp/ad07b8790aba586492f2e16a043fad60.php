<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:101:"/www/wwwroot/zhaopin.zzlanshan.site/public/../application/admin/view/zpwxsys/companyaccount/edit.html";i:1765419789;s:78:"/www/wwwroot/zhaopin.zzlanshan.site/application/admin/view/layout/default.html";i:1746006160;s:75:"/www/wwwroot/zhaopin.zzlanshan.site/application/admin/view/common/meta.html";i:1746006160;s:77:"/www/wwwroot/zhaopin.zzlanshan.site/application/admin/view/common/script.html";i:1746006160;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-name" data-rule="required" class="form-control" value="<?php echo htmlentities($row['name'] ?? ''); ?>"  name="row[name]" type="text">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-password" class="form-control" name="row[password]" type="password">
        </div>
    </div>
