<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"/www/wwwroot/zhaopin.zzlanshan.site/public/../application/admin/view/zpwxsys/news/edit.html";i:1765419789;s:78:"/www/wwwroot/zhaopin.zzlanshan.site/application/admin/view/layout/default.html";i:1746006160;s:75:"/www/wwwroot/zhaopin.zzlanshan.site/application/admin/view/common/meta.html";i:1746006160;s:77:"/www/wwwroot/zhaopin.zzlanshan.site/application/admin/view/common/script.html";i:1746006160;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <select class="cate form-control" name="row[cateid]"   >
                ...
                <option value="<?php echo htmlentities($v['id'] ?? ''); ?>" <?php if($row['cateid'] == $v['id']): ?>selected<?php endif; ?> ><?php echo htmlentities($v['name'] ?? ''); ?></option>
