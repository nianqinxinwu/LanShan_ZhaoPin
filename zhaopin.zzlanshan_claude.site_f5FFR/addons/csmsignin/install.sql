...
CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_clogininfo` (
  ...
  `settingjson` text COLLATE utf8mb4_general_ci COMMENT '配置',
  `createtime` bigint(16) DEFAULT NULL COMMENT '创建时间',
  `status` enum('normal','hidden') COLLATE utf8mb4_general_ci DEFAULT 'normal',
  PRIMARY KEY (`id`),
  KEY `ix_csmsignin_clogininfo_user_id` (`user_id`),
  KEY `ix_csmsignin_clogininfo_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='用户配置'
;
...
CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_cloginlog` (
  ...
  `recontent` text COLLATE utf8mb4_general_ci,
  `septime` bigint(16) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4101 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志'
;
...
CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_cloginmessage` (
  ...
  `objectcode` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '对象名称',
  `objectid` varchar(50) COLLATE DEFAULT NULL COMMENT '对象ID',
  `isread` enum('Y','N') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '是佛已读:Y=已读,N=未读',
...
CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_cloginthird` (
  ...
  `expires_in` bigint(16) unsigned DEFAULT '0' COMMENT '有效期',
...
CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_commoninterfacelog` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `methodtype` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Method方法',
  `createtime` bigint(16) DEFAULT NULL COMMENT '创建时间',
  `url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'URl',
  `request_post` text COLLATE utf8mb4_general_ci COMMENT 'sp',
  `request_result` text COLLATE utf8mb4_general_ci COMMENT 'sr',
  `costsecond` int(11) DEFAULT NULL COMMENT '花费时间',
  `issuccess` enum('Y','N') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '是否成功:Y=是,N=否',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_dmo` (
  ...
  `csmsignin_dmocategory_ids` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '分类（多选）',
  `type` enum('T1','T2') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类型:T1=类型1,T2=类型2',
  `types` set('T1','T2') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类型(多选):T1=类型1,T2=类型2',
  `isread` enum('Y','N') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '是否已读:Y=是,N=否',
  `content` text COLLATE utf8mb4_general_ci COMMENT '正文',
  `bannerimage` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '附件（单个）',
  `images` varchar(2000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '附件（多个）',
  ...
  `status` enum('normal','hidden') COLLATE utf8mb4_general_ci DEFAULT 'normal' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='DMO'
;

CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_dmo2category` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `csmsignin_dmo_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'DMO',
  `csmsignin_dmocategory_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'DMO分类',
  `user_id` int(10) DEFAULT '0' COMMENT '会员ID',
  `admin_id` int(10) DEFAULT '0' COMMENT '管理员ID',
  `createtime` bigint(16) DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint(16) DEFAULT NULL COMMENT '更新时间',
  ...
  `status` enum('normal','hidden') COLLATE utf8mb4_general_ci DEFAULT 'normal' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='DMO所属分类'
;
...
CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_dmoapply` (
  ...
  `bannerimage` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '附件（单个）',
  `images` varchar(2000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '附件（多个）',
  `auditcontent` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审核意见',
  `user_id` int(10) DEFAULT '0' COMMENT '会员ID',
  `admin_id` int(10) DEFAULT '0' COMMENT '管理员ID',
  `createtime` bigint(16) DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint(16) DEFAULT NULL COMMENT '更新时间',
  `weigh` int(10) DEFAULT '0' COMMENT '权重',
  `status` enum('normal','hidden','draft','toaudit','reject') COLLATE utf8mb4_general_ci DEFAULT 'draft' COMMENT '状态:toaudit=待审,reject=审核退回,normal=发布,draft=草稿,hidden=已删除,',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='DMO申请'
;
...
CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_dmocategory` (
  ...
  `status` enum('normal','hidden') COLLATE utf8mb4_general_ci DEFAULT 'normal' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='DEMO分类'
;

CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_dmoitem` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `csmsignin_dmo_id` varchar(50) COLLATE DEFAULT NULL COMMENT 'DMO',
  `name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '名称',
  `type` enum('type1','type2') COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类型:type1=类型1,type2=类型2',
  `type1_val` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类型1值',
  `type2_val` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类型2值',
  `user_id` int(10) DEFAULT '0' COMMENT '会员ID',
  `admin_id` int(10) DEFAULT '0' COMMENT '管理员ID',
  `createtime` bigint(16) DEFAULT NULL COMMENT '创建时间',
  `updatetime` bigint(16) DEFAULT NULL COMMENT '更新时间',
  ...
  `status` enum('normal','hidden') COLLATE utf8mb4_general_ci DEFAULT 'normal' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='DEMO明细'
;
...
CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_conf` (
  ...
  `begintime` bigint(16) unsigned NOT NULL COMMENT '签到开始时间',
  `endtime` bigint(16) unsigned NOT NULL COMMENT '签到截止时间',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='活动信息';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_confinfo` (
  ...
  `b9` varchar(100) DEFAULT NULL COMMENT '备用字段9',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='活动内容信息';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__csmsignin_confuser` (
  ...
  `signintime` bigint(16) unsigned COMMENT '签到时间',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='活动信息';
