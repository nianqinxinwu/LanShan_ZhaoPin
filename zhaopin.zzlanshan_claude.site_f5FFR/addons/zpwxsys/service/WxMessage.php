<?php
    ...
    class WxMessage
    {
        ...
        protected function sendMessage($openID)
        {
            ...
            $data = ['touser' => $openID, 'template_id' => $this->tplID, 'page' => $this->page, 'form_id' => $this->formID, 'data' => $this->data, //            'color' => $this->color,
                'emphasis_keyword' => $this->emphasisKeyWord];
            $result = $curlService->curl_post($this->sendUrl, $data);
